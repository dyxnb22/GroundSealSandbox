...
This document defines the subsystem shape for GroundSealSandbox, including trust
boundaries, main components, and integration seams.

## Core Responsibilities

- sandbox strategy selection, filesystem and network constraints, preflight checks, execution logging, and deterministic failure handling
