...
GroundSealSandbox is a subsystem-first project focused on sandbox strategy selection, filesystem and network constraints, preflight checks, execution logging, and deterministic failure handling.
